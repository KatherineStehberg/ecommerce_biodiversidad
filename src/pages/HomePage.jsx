    ...
    <PageContainer>
      <MainImageBox sx={{ flexDirection: { xs: "column", md: "row" } }}>
        <CardContent>
          ...
          Bienvenidos a Biodiversidad.cl: Tu Market Place Sostenible
          </Typography>
          <Typography variant="h4" sx={{ color: Colors.primaryLight }}>
          En Biodiversidad.cl, te conectamos con productos y servicios comprometidos con la biodiversidad 
          y la sostenibilidad. Somos una plataforma innovadora que une a consumidores conscientes con expertos
         y proveedores especializados en soluciones ecológicas. 
          </Typography>
        </CardContent>
        <CardMedia
          sx={{
